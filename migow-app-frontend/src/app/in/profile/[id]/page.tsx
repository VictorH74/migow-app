...
import { NotificationTypeEnum, ProfileSettingsType, UserType, VisibilityEnum } from '@/types';
...
export default function ProfilePage({ params }: { params: { id: string } }) {
  ...
  // WITH API
  // const ownerUser = await api.getOwnerUser(params.id)
  const ownerUser = usersMock.find(user => user.id === params.id)
  ...
  // temp
  const profileSettings: ProfileSettingsType = {
    id: "aaa",
  ...
  const firstTwoFollowers: UserType[] = []
